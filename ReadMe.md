...
future work : we can add multiple AI models , if one's limit is exausted then we can you other models , we can add the popup for the user to follow how to use the app . make it a proper rag.
